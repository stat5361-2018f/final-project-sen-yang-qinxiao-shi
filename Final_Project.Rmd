...
$$\frac1{N}\sum_{i=1}^n\sum_{j=1}^m\widetilde{\boldsymbol{x}}_{im}[y_{i}-\mu_i(\widetilde{\boldsymbol{x}}_{im})]+\frac1{n}\sum_{i=1}^n\hat{\Sigma_i}\boldsymbol{\beta} \dot{\mu_i}=0.$$
